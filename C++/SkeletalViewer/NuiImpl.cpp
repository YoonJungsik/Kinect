...
void CSkeletalViewerApp::Nui_GotColorAlert( )
{
    ...
    INuiFrameTexture * pTexture = imageFrame.pFrameTexture;
		...
		int a = sizeof(INuiFrameTexture);

    NUI_LOCKED_RECT LockedRect;

		int b = sizeof(imageFrame);
...
void CSkeletalViewerApp::Nui_GotDepthAlert( )
{
	...
	int liTimeStamp = sizeof(imageFrame.liTimeStamp);
	int dwFrameNumber = sizeof(imageFrame.dwFrameNumber);
	int eImageType = sizeof(imageFrame.eImageType);
	int eResolution = sizeof(imageFrame.eResolution);
	int pFrameTexture = sizeof(imageFrame.pFrameTexture);

	int dwFrameFlags = sizeof(imageFrame.dwFrameFlags);
	int ViewArea = sizeof(imageFrame.ViewArea);



    INuiFrameTexture * pTexture = imageFrame.pFrameTexture;

		int ppTexture = sizeof(pTexture);

    int BufferLen = pTexture->BufferLen();
    int Pitch = pTexture->Pitch();
