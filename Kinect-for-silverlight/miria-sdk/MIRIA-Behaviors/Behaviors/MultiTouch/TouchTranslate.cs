...
{
    public class TouchTranslate : Behavior<DependencyObject>
    {
        private TCanvas _tcanvas;
        private Point _cposition;
        ...
        void targetelement_Loaded(object sender, RoutedEventArgs e)
        {
            if (_tcanvas == null)
            {
                ...
                _tcanvas.Translate += new TCanvas.TranslateHandler(_tcanvas_Translate);
                _cposition = _tcanvas.TransformHelper.Translate;
            }
        }

        void _tcanvas_Translate(object sender, GestureTranslateEventArgs e)
        {
            _cposition.X += e.TranslationShift.X;
            _cposition.Y += e.TranslationShift.Y;
            _tcanvas.TransformHelper.Translate = _cposition;
        }
