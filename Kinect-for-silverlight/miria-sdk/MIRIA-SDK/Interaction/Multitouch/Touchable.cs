...
namespace MIRIA.Interaction.MultiTouch
{
    ...
    {
        void FingerDown(object sender, FingerTouchEventArgs e);
        void FingerMove(object sender, FingerTouchEventArgs e);
        void FingerUp(object sender, FingerTouchEventArgs e);
    }
}
